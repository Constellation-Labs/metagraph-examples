...
import org.tessellation.currency.{BaseDataApplicationL1Service, DataApplicationL1Service, DataApplicationValidationError, DataState, DataUpdate}
...
object Main
  ...
  override def dataApplication: Option[BaseDataApplicationL1Service[IO]] = Option(BaseDataApplicationL1Service(Acme.energy))
}
